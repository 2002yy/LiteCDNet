...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    elif args.net_G == 'A2Net2.0':
        net = A2Net_v2(input_nc=3, output_nc=2)  # 使用改进后的A2Net，与原A2Net使用相同的类但已在compare/A2Net.py中实现改进
    ...
    elif args.net_G == 'LiteCDNet':
        from compare.LiteCDNET import LiteCDNet
        net = LiteCDNet(output_nc=args.n_class)
