    ...
    def write(self, message):
        ...
        try:
            ...
            raise PermissionError(
                f"Cannot write to log file: {self.log_path}\n"
                "Possible cause: the log file is still occupied by another running or hung training process.\n"
                "Suggested action: close the previous training process, or change project_name/checkpoint_dir before restarting."
            ) from exc
